...
namespace Business.Concrete
{
    public class CustomerManager : ICustomerService
    {
        ...
        {
            return new SuccessDataResult<CustomerDetailDto>(_customerDal.GetCustomersDetail(x => x.Id == id).FirstOrDefault(), Messages.CustomerListed);
        }

        public IDataResult<CustomerDetailDto> GetCustomerDetailByUserId(int id)
        {
            return new SuccessDataResult<CustomerDetailDto>(_customerDal.GetCustomersDetail(x => x.UserId == id).FirstOrDefault(), Messages.CustomerListed);
        }
